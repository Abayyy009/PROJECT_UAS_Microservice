							...
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<tbody>
										...
										$stmt = $conn->prepare("SELECT * FROM invoice WHERE invoice_customer = :id ORDER BY invoice_id DESC");
											...
											<tr>
												...
												<td class="text-center">
													...
													switch ($i['invoice_status']) {
														case 0:
															$status_label = "<span class='label label-warning'>Menunggu Pembayaran</span>";
															break;
														case 1:
															$status_label = "<span class='label label-default'>Menunggu Konfirmasi</span>";
															break;
														case 2:
															$status_label = "<span class='label label-danger'>Ditolak</span>";
															break;
														case 3:
															$status_label = "<span class='label label-primary'>Dikonfirmasi & Sedang Diproses</span>";
															break;
														case 4:
															$status_label = "<span class='label label-warning'>Dikirim</span>";
															break;
														case 5:
															$status_label = "<span class='label label-success'>Selesai</span>";
															break;
														default:
															$status_label = "<span class='label label-default'>Status Tidak Dikenali</span>";
															break;
													}
													echo $status_label;
													?>
